...
describe('resolveConcepts maps query to form', () => {
  const resolveTestCases = [
    ...
    [
      ...
      {
        cancerType: {name: "UNKNOWN", codes: TYPE_EXPECTATION["Main Type A"].codes}
      },
    ...
    [ "Cancer Type - Multi id",
      {
        cancerType: {name: "UNKNOWN", codes: TYPE_EXPECTATION["Main Type B"].codes}
      },
