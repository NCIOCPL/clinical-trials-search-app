...
export const API_DISEASE_MOCKS = {
  ...
  "Main Type B": {name: "Main Type B", codes: ["C1112", "C1113"], type: ["maintype"] },
  "Main Type C": {name: "Main Type C", codes: ["C1114"], type: ["maintype", "subtype"] },
  "Subtype A": {name: "Subtype A", codes: ["C2222"], type: ["subtype"]},
  "Subtype B": {name: "Subtype B", codes: ["C2223","C2224"], type: ["subtype"]},
  "Stage A": {name: "Stage A", codes: ["C3333"], type: ["stage"]},
  "Stage B": {name: "Stage B", codes: ["C3334","C3335"], type: ["stage"]},
  "Stage C": {name: "Stage C", codes: ["C3336","C3337","C3338"], type: ["grade", "subtype", "stage"]},
  "Finding A": {name: "Finding A", codes: ["C4444"], type: ["finding"]},
  "Finding B": {name: "Finding B", codes: ["C4445", "C4446"], type: ["finding"]}
}
...
export const API_INTERVENTION_MOCKS = {
  ...
  "Drug Category A": {name: "Drug Category A", codes: ["C5558"], category: "agent category"},
  "Treatment A": {name: "Treatment A", codes: ["C6666"], category: "none"},
  "Treatment B": {name: "Treatment B", codes: ["C6667", "C6668"], category: "other"},
}
...
export const getDiseaseFetcher = (ids, rtnDiseases) => {
  return async (ids) => Object.entries(API_DISEASE_MOCKS)
...
export const getInterventionFetcher = (ids, rtnInterventions) => {
  return async (ids) => Object.entries(API_INTERVENTION_MOCKS)
