...
describe('Adv - queryStringToFormObject maps query to form', () => {
  ...
  const goodMappingTestCases = [
    ...
    [ "lead organization - with comma",
      ...
      async () => null,
      {
        leadOrg: { term: 'Mayo Clinic, Mayo Clinic', termKey: 'Mayo Clinic, Mayo Clinic' },
        formType: "advanced"
      }
    ],
    ...
    [ "Principal Investigator - with comma",
      ...
      async () => null,
      {
        investigator: { term: 'Sophia Smith,M.D.', termKey: 'Sophia Smith,M.D.' },
        formType: "advanced"
      }
    ],
    [ "Trial ID",
    ...
    [
      ...
      async () => null,
      {
        trialTypes: getExpectedTrialTypes(['basic_science','treatment','supportive_care']),
        formType: "advanced"
      }
    ],
    [
